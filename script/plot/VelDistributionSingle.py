...
plt.subplot(4,1,1)
plt.plot(v,maxwellian)
plt.hist(speed0, bins=1000, density=True)
#plt.ylim([0,3000])
#plt.xlim([0,0.0012])
...
plt.subplot(3,1,1)
plt.plot(v,maxwellian)
plt.hist(speed0x, bins=1000, density=True)	
...
for d in range(Nd):
	...
	plt.hist(vel0[:,d], bins=100, density=True)
...
for d in range(Nd):
	plt.subplot(Nd,1,d+1)
	plt.hist(pos[:,d], bins=100, density=True)
