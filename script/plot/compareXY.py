...
fileRhoX = h5py.File('test_rho.grid.h5','r')
filePopX = h5py.File('test_pop.pop.h5', 'r')
...
popX = filePopX['/pos/specie 0/n=0.0']
pop = popX

popTemp = []

for i in range(pop.shape[0]):
	if pop[i,0] < 25 and  pop[i,0] >5:
