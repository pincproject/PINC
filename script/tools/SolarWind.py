...
debye = m.sqrt((c.epsilon_0 * c.Boltzmann * temp) / (c.elementary_charge**2 * 4 * m.pi * num_density * 1e6))
print "Numerical density of plasma at %f AU is %f cm^-3 \n" % (rad_dist, num_density)
print "Drift velocity of plasma at %f is %f km/s \n" % (rad_dist, drift)
print "Thermal velocity of plasma (electrons) at %f is %f km/s" % (rad_dist, thermal_vel_e/1000)
print "Thermal velocity of plasma (protons) at %f is %f km/s" % (rad_dist, thermal_vel_p/1000)
