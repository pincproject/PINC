...
import GridTools as gg # import all tools to generate the grid
...
gridpar = [-3,3,-3,3,-3,3,301,301,301]
...
# Outputfile and comment.
outfile = ["grid.vtk", "gridfile for PINC"]
...
transfo[0] = [1.5,1.5,1.5,0,0,0,1,1,1]
transfo[1] = [-1.5,-1.5,-1.5,45,45,45,0.5,0.5,0.5]
transfo[2] = [0,0,0,0,0,0,1,1,1]
...
# Write to file.
wstart = time.time()
print " 4. Write", outfile[0]
gg.writeLegacyVTK(grid, gridpar, outfile)
wstop = time.time()
