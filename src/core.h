...
typedef struct{
	...
	bool *objVicinity; ///< buffer of particles that are close to an object
	bool *collisions; ///< buffer of particle indecies that will collide with an object in the next timestep
